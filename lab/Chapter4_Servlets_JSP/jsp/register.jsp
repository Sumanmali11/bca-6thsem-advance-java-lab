...
<%
    ...
    String name = "", email = "", gender = "", password = "", imageName = "", error = "";
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            ...
            if (name.isEmpty() || email.isEmpty() || gender == null || password.isEmpty()) {
    ...
    String sessionImage = (String) session.getAttribute("imageName");
%>
...
<head>
    ...
    <style>
        ...
        .btn { margin-top: 15px; background: #007bff; color: white; border: none; padding: 10px; cursor: pointer; }
        .error { color: red; text-align: center; }
        .visitor { text-align: center; margin-bottom: 10px; }
...
<% if (sessionUserName != null) { %>
    <div class="welcome">
        ...
        <% if (sessionImage != null && !sessionImage.isEmpty()) { %>
            <img src="uploads/<%= sessionImage %>" width="120" style="border-radius: 50%;">
        <% } %>
    </div>
<% } else { %>
